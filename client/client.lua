...
RegisterNetEvent("qb-materialrobbery:client:RoubarCobre", function() 
    listening = true
        ...
        while listening do
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not caixaFound and not currentlySearching then
                    ...
                    QBCore.Functions.Progressbar("RoubarCobre", "Stealing Materials...", 6000, false, false, {
                        ...
                        TriggerServerEvent("qb-materialrobbery:server:RoubarCobre")
                        notifiedOfFailure = true
                        TriggerServerEvent('qb-materialrobbery:server:ComecarCooldown', caixa)
